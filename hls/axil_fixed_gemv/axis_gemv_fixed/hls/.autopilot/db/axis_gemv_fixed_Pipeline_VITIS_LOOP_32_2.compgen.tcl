...
set name axis_gemv_fixed_mul_25s_25s_50_1_1
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { strm_out_TREADY { I 1 bit } strm_out_TDATA { O 32 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename localmem \
    op interface \
    ports { localmem_address0 { O 9 vector } localmem_ce0 { O 1 bit } localmem_q0 { I 25 vector } } \
} "
} else {
