...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler axis_gemv_fixed_localmem_RAM_AUTO_1R1W BINDTYPE {storage} TYPE {ram} IMPL {auto} LATENCY 2 ALLOW_PRAGMA 1
}
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler axis_gemv_fixed_regslice_both BINDTYPE {interface} TYPE {adapter} IMPL {reg_slice}
}
