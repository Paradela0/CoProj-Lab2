...
using hls::sim::Byte;
extern "C" void axis_gemv_fixed(volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *);
extern "C" void apatb_axis_gemv_fixed_hw(volatile void * __xlx_apatb_param_strm_in_V_data_V, volatile void * __xlx_apatb_param_strm_in_V_keep_V, volatile void * __xlx_apatb_param_strm_in_V_strb_V, volatile void * __xlx_apatb_param_strm_in_V_last_V, volatile void * __xlx_apatb_param_strm_out_V_data_V, volatile void * __xlx_apatb_param_strm_out_V_keep_V, volatile void * __xlx_apatb_param_strm_out_V_strb_V, volatile void * __xlx_apatb_param_strm_out_V_last_V) {
using hls::sim::createStream;
auto* sstrm_in_V_data_V = createStream((hls::stream<int>*)__xlx_apatb_param_strm_in_V_data_V);
...
auto* sstrm_out_V_last_V = createStream((hls::stream<char>*)__xlx_apatb_param_strm_out_V_last_V);
  // DUT call
  axis_gemv_fixed(sstrm_in_V_data_V->data<int>(), sstrm_in_V_keep_V->data<char>(), sstrm_in_V_strb_V->data<char>(), sstrm_in_V_last_V->data<char>(), sstrm_out_V_data_V->data<int>(), sstrm_out_V_keep_V->data<char>(), sstrm_out_V_strb_V->data<char>(), sstrm_out_V_last_V->data<char>());
sstrm_in_V_data_V->transfer((hls::stream<int>*)__xlx_apatb_param_strm_in_V_data_V);
