...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { strm_in_TVALID { I 1 bit } strm_in_TDATA { I 32 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename localmem \
    op interface \
    ports { localmem_address0 { O 9 vector } localmem_ce0 { O 1 bit } localmem_we0 { O 1 bit } localmem_d0 { O 25 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'localmem'"
}
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_i_out \
    op interface \
    ports { i_out { O 9 vector } i_out_ap_vld { O 1 bit } } \
} "
}
...
set InstName axis_gemv_fixed_flow_control_loop_pipe_sequential_init_U
set CompName axis_gemv_fixed_flow_control_loop_pipe_sequential_init
set name flow_control_loop_pipe_sequential_init
if {${::AESL::PGuard_autocg_gen} && ${::AESL::PGuard_autocg_ipmgen}} {
if {[info proc ::AESL_LIB_VIRTEX::xil_gen_UPC_flow_control] == "::AESL_LIB_VIRTEX::xil_gen_UPC_flow_control"} {
eval "::AESL_LIB_VIRTEX::xil_gen_UPC_flow_control { \
    name ${name} \
    prefix axis_gemv_fixed_ \
}"
} else {
