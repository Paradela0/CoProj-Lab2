...
set ::env(LD_LIBRARY_PATH) /opt/Xilinx/Vitis_HLS/2024.1/lib/lnx64.o/Default:$::env(LD_LIBRARY_PATH)
...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "axis_gemv_fixed.autotvin.dat"
	set constFileTvOut       "axis_gemv_fixed.autotvout.dat"
	set constFileHdlTvIn     "axis_gemv_fixed.autohdltvin.dat"
	set constFileHdlTvOut    "axis_gemv_fixed.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
